...
public class FloatingDataOnStackedBarCase extends BaseComposite {

	private final HTMLTableElement mainPanel;
	
	private final StackedBarChart chart = new StackedBarChart();

	public FloatingDataOnStackedBarCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		chart.getOptions().getTitle().setText("Floating data on stacked bar chart");
