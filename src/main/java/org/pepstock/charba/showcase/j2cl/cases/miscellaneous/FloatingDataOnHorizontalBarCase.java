...
public class FloatingDataOnHorizontalBarCase extends BaseComposite {

	private final HTMLTableElement mainPanel;
	
	private final HorizontalBarChart chart = new HorizontalBarChart();

	public FloatingDataOnHorizontalBarCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		HorizontalBarDataset dataset2 = chart.newDataset();
	...
	protected void handleRandomize() {
		for (Dataset dataset : chart.getData().getDatasets()) {
			double[] values = getRandomDigits(months);
			double[] gaps = getRandomDigits(months, false);
			HorizontalBarDataset barDataset = (HorizontalBarDataset)dataset;
