...
public class FilteringLegendCase extends BaseComposite {
	...
	private final HTMLInputElement filter = (HTMLInputElement) DomGlobal.document.createElement("input");

	public FilteringLegendCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		chart.getOptions().getTitle().setText("Filtering hidden datasets on line chart");
