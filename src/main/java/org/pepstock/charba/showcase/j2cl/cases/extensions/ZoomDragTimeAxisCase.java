...
public class ZoomDragTimeAxisCase extends BaseComposite {
	...
	public ZoomDragTimeAxisCase() {
		...
		chart.getOptions().getTitle().setText("Drag to zoom on cartesian time axis");
