...
public class HtmlLegendSplittingTextCase extends BaseComposite {
	...
	public HtmlLegendSplittingTextCase() {
		...
		chart.getOptions().getTitle().setText("HTML legend splitting text on bar chart");

		BarDataset dataset1 = chart.newDataset();
		dataset1.setLabel("This is dataset 1\n which contains data");
		...
		dataset2.setLabel("This is dataset 2\n which contains data");
	...
	protected void handleAddDataset() {
		...
		dataset.setLabel("This is dataset " + (datasets.size() + 1) + "\n which contains data ");
