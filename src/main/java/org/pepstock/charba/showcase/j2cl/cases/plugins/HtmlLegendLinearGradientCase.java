...
public class HtmlLegendLinearGradientCase extends BaseComposite {
	...
	public HtmlLegendLinearGradientCase() {
		...
		chart.getOptions().getTitle().setText("HTML legend applying a linear gradient on line chart dataset");
