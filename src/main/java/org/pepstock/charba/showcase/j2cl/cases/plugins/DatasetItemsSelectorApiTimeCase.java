...
public class DatasetItemsSelectorApiTimeCase extends BaseComposite {
	...
	public DatasetItemsSelectorApiTimeCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		chart.getOptions().getTitle().setText("Dataset items selector plugin API on time axis");
	...
	protected void handleSelect() {
		...
		double to = time + ((int)getRandomDigit(0, AMOUNT_OF_POINTS - 1)) * DAY + getRandomDigit(60000, 300000);
