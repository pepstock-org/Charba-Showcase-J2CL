...
public class ZoomOnHorizontalBarCase extends BaseComposite {

	private final HTMLTableElement mainPanel;

	private final HorizontalBarChart chart = new HorizontalBarChart();

	public ZoomOnHorizontalBarCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		chart.getOptions().getTitle().setText("Zooming on horizontal bar chart");
