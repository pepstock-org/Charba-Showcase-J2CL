...
public class AreaBackgroundColorBarCase extends BaseComposite {

	private final HTMLTableElement mainPanel;

	private final BarChart chart = new BarChart();

	public AreaBackgroundColorBarCase() {
		// ----------------------------------------------
		// Main element
		// ----------------------------------------------
		...
		ChartBackgroundColorOptionsBuilder.create(chart).setAreaBackgroundColor("rgba(208, 208, 208, 0.2)").build().store(chart);
