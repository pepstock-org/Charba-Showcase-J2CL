...
class $Overlay {
 ...
 /** @return {Request} */
 static m_asRequest__$devirt__elemental2_dom_DomGlobal_FetchInputUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Request}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), Request_$Overlay));
 }
 /** @return {?string} */
 static m_asString__$devirt__elemental2_dom_DomGlobal_FetchInputUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object($thisArg);
 }
 /** @return {boolean} */
 static m_isRequest__$devirt__elemental2_dom_DomGlobal_FetchInputUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Request_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isString__$devirt__elemental2_dom_DomGlobal_FetchInputUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
