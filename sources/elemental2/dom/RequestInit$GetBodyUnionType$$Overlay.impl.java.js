...
class $Overlay {
 ...
 /** @return {ArrayBuffer} */
 static m_asArrayBuffer__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBuffer}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), ArrayBuffer_$Overlay));
 }
 /** @return {ArrayBufferView} */
 static m_asArrayBufferView__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBufferView}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), ArrayBufferView_$Overlay));
 }
 /** @return {Blob} */
 static m_asBlob__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Blob}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), Blob_$Overlay));
 }
 /** @return {FormData} */
 static m_asFormData__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {FormData}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), FormData_$Overlay));
 }
 /** @return {ReadableStream} */
 static m_asReadableStream__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ReadableStream}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), ReadableStream_$Overlay));
 }
 /** @return {?string} */
 static m_asString__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asString__java_lang_Object($thisArg);
 }
 /** @return {URLSearchParams} */
 static m_asURLSearchParams__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {URLSearchParams}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), URLSearchParams_$Overlay));
 }
 /** @return {boolean} */
 static m_isArrayBuffer__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBuffer_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isArrayBufferView__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBufferView_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isBlob__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Blob_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isFormData__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return FormData_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isReadableStream__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ReadableStream_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isString__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return j_l_String.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isURLSearchParams__$devirt__elemental2_dom_RequestInit_GetBodyUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
