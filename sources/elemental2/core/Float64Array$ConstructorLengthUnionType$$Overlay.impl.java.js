...
class $Overlay {
 ...
 /** @return {ArrayBuffer} */
 static m_asArrayBuffer__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBuffer}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), ArrayBuffer_$Overlay));
 }
 /** @return {ArrayBufferView} */
 static m_asArrayBufferView__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {ArrayBufferView}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), ArrayBufferView_$Overlay));
 }
 /** @return {number} */
 static m_asInt__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_asInt__java_lang_Object($thisArg);
 }
 /** @return {Array<?number>} */
 static m_asJsArray__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Array<?number>}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), JsArray_$Overlay));
 }
 /** @return {SharedArrayBuffer} */
 static m_asSharedArrayBuffer__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {SharedArrayBuffer}*/ ($Casts.$to(Js.m_cast__java_lang_Object($thisArg), SharedArrayBuffer_$Overlay));
 }
 /** @return {boolean} */
 static m_isArrayBuffer__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBuffer_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isArrayBufferView__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return ArrayBufferView_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isInt__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Double.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isJsArray__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return JsArray_$Overlay.$isInstance(/**@type {*}*/ ($thisArg));
 }
 /** @return {boolean} */
 static m_isSharedArrayBuffer__$devirt__elemental2_core_Float64Array_ConstructorLengthUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
