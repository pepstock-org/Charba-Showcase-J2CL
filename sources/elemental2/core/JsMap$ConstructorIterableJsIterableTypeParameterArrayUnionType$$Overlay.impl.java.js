...
class $Overlay {
 ...
 static m_asKEY__$devirt__elemental2_core_JsMap_ConstructorIterableJsIterableTypeParameterArrayUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_cast__java_lang_Object($thisArg);
 }
 /** @template KEY, VALUE @return {VALUE} */
 static m_asVALUE__$devirt__elemental2_core_JsMap_ConstructorIterableJsIterableTypeParameterArrayUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return Js.m_cast__java_lang_Object($thisArg);
 }
