...
class $Overlay {
 ...
 static m_asJsArray__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
 ...
 static m_asJsIterable__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
  return /**@type {Iterable<VALUE>}*/ (Js.m_cast__java_lang_Object($thisArg));
 }
 /** @template VALUE @return {boolean} */
 static m_isJsArray__$devirt__elemental2_core_JsSet_ConstructorIterableUnionType(/** ? */ $thisArg) {
  $Overlay.$clinit();
