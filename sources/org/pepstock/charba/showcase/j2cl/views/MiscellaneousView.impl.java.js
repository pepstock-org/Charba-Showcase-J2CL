goog.module('org.pepstock.charba.showcase.j2cl.views.MiscellaneousView$impl');
...
let Category = goog.forwardDeclare('org.pepstock.charba.showcase.j2cl.views.MiscellaneousView.Category$impl');
let ControllersCase = goog.forwardDeclare('org.pepstock.charba.showcase.j2cl.views.MiscellaneousView.ControllersCase$impl');
let $Casts = goog.forwardDeclare('vmbootstrap.Casts$impl');
let $Objects = goog.forwardDeclare('vmbootstrap.Objects$impl');

class MiscellaneousView extends AbstractView {
 /** @protected */
 constructor() {
  super();
 }
 ...
 static $create__elemental2_dom_HTMLElement(/** HTMLElement */ content) {
  MiscellaneousView.$clinit();
  let $instance = new MiscellaneousView();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView__elemental2_dom_HTMLElement(content);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView__elemental2_dom_HTMLElement(/** HTMLElement */ content) {
  ...
  for (let $array = Category.m_values__(), $index = 0; $index < $array.length; $index++) {
   let cat = $array[$index];
   {
    ...
    if ($Objects.m_equals__java_lang_Object__java_lang_Object(Category.f_PLUGINS__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView_Category, cat)) {
     ...
     item1.innerHTML = ControllersCase.f_SIMPLE__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView_ControllersCase.m_getLabel__();
     item1.onclick = (/** Event */ p0_1) =>{
      let composite_1 = ControllersCase.f_SIMPLE__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView_ControllersCase.m_getFactory__().m_create__();
     ...
     item2.innerHTML = ControllersCase.f_FLAGS__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView_ControllersCase.m_getLabel__();
     item2.onclick = (/** Event */ p0_2) =>{
      let composite_2 = ControllersCase.f_FLAGS__org_pepstock_charba_showcase_j2cl_views_MiscellaneousView_ControllersCase.m_getFactory__().m_create__();
 ...
 static $clinit() {
  MiscellaneousView.$clinit = () =>{};
  MiscellaneousView.$loadModules();
  AbstractView.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof MiscellaneousView;
 }
 ...
 static $loadModules() {
  ...
  Category = goog.module.get('org.pepstock.charba.showcase.j2cl.views.MiscellaneousView.Category$impl');
  ControllersCase = goog.module.get('org.pepstock.charba.showcase.j2cl.views.MiscellaneousView.ControllersCase$impl');
  $Casts = goog.module.get('vmbootstrap.Casts$impl');
  $Objects = goog.module.get('vmbootstrap.Objects$impl');
 }
}
$Util.$setClassMetadata(MiscellaneousView, "org.pepstock.charba.showcase.j2cl.views.MiscellaneousView");

exports = MiscellaneousView;

//# sourceMappingURL=MiscellaneousView.js.map
