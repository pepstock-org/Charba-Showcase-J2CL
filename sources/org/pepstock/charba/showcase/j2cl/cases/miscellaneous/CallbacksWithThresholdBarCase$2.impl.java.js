goog.module('org.pepstock.charba.showcase.j2cl.cases.miscellaneous.CallbacksWithThresholdBarCase.$2$impl');
...
class $2 extends j_l_Object {
 ...
 constructor() {
  ...
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_2;
 }
 /** @return {!$2} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase(/** CallbacksWithThresholdBarCase */ $outer_this) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_2__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_2__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase(/** CallbacksWithThresholdBarCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_2 = $outer_this;
  this.$ctor__java_lang_Object__();
 }
 /** @return {IsColor} */
 m_invoke__org_pepstock_charba_client_callbacks_DatasetContext(/** DatasetContext */ context) {
  let dataset = /**@type {Dataset}*/ ($Casts.$to(this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_2.f_chart__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_.m_getData__().m_getDatasets__().getAtIndex(context.m_getDatasetIndex__()), Dataset));
  ...
  if (Double.m_doubleValue__java_lang_Double(value) >= CallbacksWithThresholdBarCase.f_ERROR__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_) {
   return CallbacksWithThresholdBarCase.f_ERROR_COLOR__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_;
   ...
   return CallbacksWithThresholdBarCase.f_WARNING_COLOR__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_;
  }
  return CallbacksWithThresholdBarCase.f_INFO_COLOR__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_CallbacksWithThresholdBarCase_;
 }
 //Bridge method.
...
$Util.$setClassMetadata($2, "org.pepstock.charba.showcase.j2cl.cases.miscellaneous.CallbacksWithThresholdBarCase$2");

exports = $2;

//# sourceMappingURL=CallbacksWithThresholdBarCase$2.js.map
