goog.module('org.pepstock.charba.showcase.j2cl.cases.miscellaneous.TrendAndForecastCase.$2$impl');
...
class $2 extends AbstractTooltipTitleCallback {
 /** @protected */
 constructor() {
  super();
  /**@type {TrendAndForecastCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2;
  /**@type {DateAdapter}*/
  this.$captured_adapter__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2;
 }
 /** @return {!$2} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase__org_pepstock_charba_client_adapters_DateAdapter(/** TrendAndForecastCase */ $outer_this, /** DateAdapter */ $captured_adapter) {
  $2.$clinit();
  let $instance = new $2();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase__org_pepstock_charba_client_adapters_DateAdapter($outer_this, $captured_adapter);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase__org_pepstock_charba_client_adapters_DateAdapter(/** TrendAndForecastCase */ $outer_this, /** DateAdapter */ $captured_adapter) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2 = $outer_this;
  this.$captured_adapter__org_pepstock_charba_showcase_j2cl_cases_miscellaneous_TrendAndForecastCase_2 = $captured_adapter;
...
$Util.$setClassMetadata($2, "org.pepstock.charba.showcase.j2cl.cases.miscellaneous.TrendAndForecastCase$2");

exports = $2;

//# sourceMappingURL=TrendAndForecastCase$2.js.map
