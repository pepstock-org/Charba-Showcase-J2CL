goog.module('org.pepstock.charba.showcase.j2cl.cases.extensions.ZoomTimeAxisCase$impl');
...
let $1 = goog.forwardDeclare('org.pepstock.charba.showcase.j2cl.cases.extensions.ZoomTimeAxisCase.$1$impl');
let $Arrays = goog.forwardDeclare('vmbootstrap.Arrays$impl');
let $Casts = goog.forwardDeclare('vmbootstrap.Casts$impl');
let $LongUtils = goog.forwardDeclare('vmbootstrap.LongUtils$impl');
let $Primitives = goog.forwardDeclare('vmbootstrap.Primitives$impl');

class ZoomTimeAxisCase extends BaseComposite {
 /** @protected */
 constructor() {
  super();
  /**@type {HTMLTableElement}*/
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
  /**@type {HTMLInputElement}*/
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
  /**@type {HTMLInputElement}*/
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
  /**@type {HTMLDivElement}*/
  this.f_help__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
  /**@type {ScatterChart}*/
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
  /**@type {!$Long}*/
  this.f_time__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = $Long.fromInt(0);
 }
 /** @return {!ZoomTimeAxisCase} */
 static $create__() {
  ZoomTimeAxisCase.$clinit();
  let $instance = new ZoomTimeAxisCase();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase__() {
  this.$ctor__org_pepstock_charba_showcase_j2cl_cases_commons_BaseComposite__();
  this.$init___$p_org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase();
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = /**@type {HTMLTableElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("table"), $Overlay));
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.width = "100%";
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.cellPadding = "12";
  let chartRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  chartRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.appendChild(chartRow);
  let chartCol = /**@type {HTMLTableCellElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("td"), HTMLTableCellElement_$Overlay));
  chartCol.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  chartRow.appendChild(chartCol);
  let adapter = DateAdapter.$create__();
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_setResponsive__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_setMaintainAspectRatio__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getTitle__().m_setDisplay__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getTitle__().m_setText__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$init(["Zooming on cartesian time axis"], j_l_String)));
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getTooltips__().m_setTitleMarginBottom__int(10);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getTooltips__().m_getCallbacks__().m_setTitleCallback__org_pepstock_charba_client_callbacks_TooltipTitleCallback($1.$create__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase__org_pepstock_charba_client_adapters_DateAdapter(this, adapter));
  let dataset1 = /**@type {ScatterDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_newDataset__(), ScatterDataset));
  ...
  this.f_time__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = Date.$create__().m_getTime__();
  let xs1 = this.m_getRandomDigits__int__double__double(ZoomTimeAxisCase.f_AMOUNT_OF_POINTS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_, 0, 1000);
  let points = dataset1.m_getDataPoints__boolean(true);
  for (let i = ZoomTimeAxisCase.f_AMOUNT_OF_POINTS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ - 1 | 0; i >= 0; i = i - 1 | 0) {
   let newTime = $LongUtils.$plus(this.f_time__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_, $Primitives.$narrowDoubleToLong(Math.random() * $Primitives.$widenLongToDouble(ZoomTimeAxisCase.f_MAX_DAYS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_)));
   let dp = DataPoint.$create__();
   dp.m_setX__java_util_Date(Date.$create__long(newTime));
   dp.m_setY__double(xs1[i]);
   points.add(dp);
  }
  let axis = CartesianTimeAxis.$create__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
  ...
  let axis2 = CartesianLinearAxis.$create__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
  axis2.m_setDisplay__boolean(true);
  axis2.m_setBeginAtZero__boolean(true);
  axis2.m_setStacked__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getData__().m_setDatasets__arrayOf_org_pepstock_charba_client_data_Dataset(/**@type {!Array<Dataset>}*/ ($Arrays.$init([dataset1], Dataset)));
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getScales__().m_setAxes__arrayOf_org_pepstock_charba_client_configuration_Axis(/**@type {!Array<Axis>}*/ ($Arrays.$init([axis, axis2], Axis)));
  ...
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.appendChild(actionsRow);
  ...
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.id = zoomId;
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.checked = true;
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.onclick = (/** Event */ p0_2) =>{
   this.m_handleZoom__();
   return null;
  };
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.type = "checkbox";
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.className = "gwt-CheckBox";
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
  ...
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.id = panId;
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.checked = true;
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.onclick = (/** Event */ p0_3) =>{
   this.m_handlePan__();
   return null;
  };
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.type = "checkbox";
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.className = "gwt-CheckBox";
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
  ...
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.appendChild(helpRow);
  ...
  this.f_help__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.innerHTML = "<kbd style=\"" + j_l_String.m_valueOf__java_lang_Object(ZoomTimeAxisCase.f_CSS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_) + "\">Alt</kbd> + wheeling to zoom";
  helpCol.appendChild(this.f_help__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
  ...
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.appendChild(logRow);
 ...
 m_getElement__() {
  return this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_;
 }
 
 m_handleRandomize__() {
  for (let $iterator = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getData__().m_getDatasets__().m_iterator__(); $iterator.m_hasNext__(); ) {
 ...
 m_handleResetZoom__() {
  ZoomPlugin.m_reset__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_);
 }
 ...
 m_handlePan__() {
  let options = /**@type {ZoomOptions}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_getOptions__().m_getPlugins__().m_getOptions__org_pepstock_charba_client_plugins_AbstractPluginOptionsFactory(ZoomPlugin.f_FACTORY__org_pepstock_charba_client_zoom_ZoomPlugin), ZoomOptions));
  options.m_getPan__().m_setEnabled__boolean(this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.checked);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_.m_update__();
 }
 ...
 $init___$p_org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase() {
  this.f_enableZoom__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = /**@type {HTMLInputElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("input"), HTMLInputElement_$Overlay));
  this.f_enablePan__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = /**@type {HTMLInputElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("input"), HTMLInputElement_$Overlay));
  this.f_help__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = /**@type {HTMLDivElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("div"), HTMLDivElement_$Overlay));
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = ScatterChart.$create__();
 }
 
 static $clinit() {
  ZoomTimeAxisCase.$clinit = () =>{};
  ZoomTimeAxisCase.$loadModules();
  BaseComposite.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ZoomTimeAxisCase;
 }
 ...
 static $loadModules() {
  ...
  $1 = goog.module.get('org.pepstock.charba.showcase.j2cl.cases.extensions.ZoomTimeAxisCase.$1$impl');
...
/**@const {!$Long}*/
ZoomTimeAxisCase.f_DAY__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = $Long.fromInt(86400000);
/**@const {!$Long}*/
ZoomTimeAxisCase.f_MAX_DAYS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = $Long.fromInt(1728000000);
/**@const {number}*/
ZoomTimeAxisCase.f_AMOUNT_OF_POINTS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = 500;
/**@const {?string}*/
ZoomTimeAxisCase.f_CSS__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomTimeAxisCase_ = "background: linear-gradient(180deg,#eee,#fff); background-color: rgba(0, 0, 0, 0); background-color: #eee; border: 1px solid #cdd5d7; border-radius: 6px; box-shadow: 0 1px 2px 1px #cdd5d7; font-family: consolas,courier,monospace; font-size: .9rem; font-weight: 700; line-height: 1; margin: 3px; padding: 4px 6px; white-space: nowrap;";
$Util.$setClassMetadata(ZoomTimeAxisCase, "org.pepstock.charba.showcase.j2cl.cases.extensions.ZoomTimeAxisCase");

exports = ZoomTimeAxisCase;

//# sourceMappingURL=ZoomTimeAxisCase.js.map
