...
class ZoomApiZoomCase extends BaseComposite {
 ...
 m_handleZoomPlus10__() {
  ZoomPlugin.m_zoom__org_pepstock_charba_client_IsChart__double__org_pepstock_charba_client_options_IsTransitionKey(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomApiZoomCase_, 1.1, DefaultTransitionKey.f_DEFAULT__org_pepstock_charba_client_enums_DefaultTransitionKey);
 }
 
 m_handleZoomMinus10__() {
  ZoomPlugin.m_zoom__org_pepstock_charba_client_IsChart__double__org_pepstock_charba_client_options_IsTransitionKey(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomApiZoomCase_, 0.9, DefaultTransitionKey.f_DEFAULT__org_pepstock_charba_client_enums_DefaultTransitionKey);
 }
 
 m_handleZoomXPlus10__() {
  ZoomPlugin.m_zoom__org_pepstock_charba_client_IsChart__org_pepstock_charba_client_zoom_Amount__org_pepstock_charba_client_options_IsTransitionKey(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_extensions_ZoomApiZoomCase_, Amount.$create__double(1.1), DefaultTransitionKey.f_DEFAULT__org_pepstock_charba_client_enums_DefaultTransitionKey);
 }
