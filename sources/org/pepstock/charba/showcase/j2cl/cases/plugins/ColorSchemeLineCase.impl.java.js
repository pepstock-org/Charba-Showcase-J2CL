goog.module('org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemeLineCase$impl');
...
class ColorSchemeLineCase extends BaseComposite {
 /** @protected */
 constructor() {
  super();
  /**@type {HTMLTableElement}*/
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
  /**@type {LineChart}*/
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
  /**@type {HTMLSelectElement}*/
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
  /**@type {HTMLSelectElement}*/
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
  /**@type {HTMLInputElement}*/
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
 }
 /** @return {!ColorSchemeLineCase} */
 static $create__() {
  ColorSchemeLineCase.$clinit();
  let $instance = new ColorSchemeLineCase();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase__() {
  this.$ctor__org_pepstock_charba_showcase_j2cl_cases_commons_BaseComposite__();
  this.$init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase();
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_ = /**@type {HTMLTableElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("table"), $Overlay));
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.width = "100%";
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.cellPadding = "12";
  let chartRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  chartRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.appendChild(chartRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(category1);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(category2);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(category3);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(category4);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(category5);
  let index = 0;
  for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
   let scheme = $array[$index];
   {
    ...
    this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(schemeN);
    if ($Objects.m_equals__java_lang_Object__java_lang_Object(BrewerScheme.f_PAIRED12__org_pepstock_charba_client_impl_plugins_enums_BrewerScheme, scheme)) {
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex = index;
    }
    index = index + 1 | 0;
   }
  }
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_setResponsive__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_getLegend__().m_setPosition__org_pepstock_charba_client_enums_Position(Position.f_TOP__org_pepstock_charba_client_enums_Position);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_getTitle__().m_setDisplay__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_getTitle__().m_setText__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$init(["Coloring line chart"], j_l_String)));
  let dataset1 = /**@type {LineDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_newDataset__(), LineDataset));
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getPlugins__().m_add__org_pepstock_charba_client_Plugin(ColorSchemes.m_get__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getData__().m_setLabels__arrayOf_java_lang_String(this.m_getLabels__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getData__().m_setDatasets__arrayOf_org_pepstock_charba_client_data_Dataset(/**@type {!Array<Dataset>}*/ ($Arrays.$init([dataset1], Dataset)));
  chartCol.appendChild(/**@type {Node}*/ ($Casts.$to(IsCastable_$Overlay.m_as__$devirt__org_pepstock_charba_client_dom_IsCastable(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getChartElement__()), Node_$Overlay)));
  let actionsRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  actionsRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.appendChild(actionsRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.onchange = (/** Event */ p0_5) =>{
   this.m_handleCategory__();
   return null;
  };
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.className = "gwt-ListBox";
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.onchange = (/** Event */ p0_6) =>{
   this.m_handleName__();
   return null;
  };
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.className = "gwt-ListBox";
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
  ...
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.id = reverseID;
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.onclick = (/** Event */ p0_7) =>{
   this.m_handleReverse__();
   return null;
  };
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.type = "checkbox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.className = "gwt-CheckBox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
 ...
 m_getElement__() {
  return this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_;
 }
 
 m_handleRandomize__() {
  for (let $iterator = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getData__().m_getDatasets__().m_iterator__(); $iterator.m_hasNext__(); ) {
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_update__();
 }
 
 m_handleAddDataset__() {
  let datasets = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getData__().m_getDatasets__();
  let dataset = /**@type {LineDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_newDataset__(), LineDataset));
 ...
 m_handleRemoveDataset__() {
  this.m_removeDataset__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
 }
 
 m_handleAddData__() {
  this.m_addData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
 }
 
 m_handleRemoveData__() {
  this.m_removeData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_);
 }
 
 m_handleReverse__() {
  let options = /**@type {ColorSchemesOptions}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_getPlugins__().m_getOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptionsFactory(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, ColorSchemes.f_FACTORY__org_pepstock_charba_client_impl_plugins_ColorSchemes), ColorSchemesOptions));
  options.m_setReverse__boolean(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.checked);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_getOptions__().m_getPlugins__().m_setOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptions(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, options);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.m_update__();
 }
 
 m_handleCategory__() {
  let selected = /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.options, this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex), HTMLOptionElement_$Overlay)).value;
  if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("brewer", selected)) {
   this.m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase();
   let index = 0;
   for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
    let scheme = $array[$index];
    {
   ...
   for (let $array_1 = OfficeScheme.m_values__(), $index_1 = 0; $index_1 < $array_1.length; $index_1++) {
    let scheme_1 = $array_1[$index_1];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(schemeN_1);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex = 0;
   ...
   for (let $array_2 = TableauScheme.m_values__(), $index_2 = 0; $index_2 < $array_2.length; $index_2++) {
    let scheme_2 = $array_2[$index_2];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(schemeN_2);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex = 0;
   ...
   for (let $array_3 = GwtMaterialScheme.m_values__(), $index_3 = 0; $index_3 < $array_3.length; $index_3++) {
    let scheme_3 = $array_3[$index_3];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(schemeN_3);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex = 0;
   ...
   for (let $array_4 = GoogleChartScheme.m_values__(), $index_4 = 0; $index_4 < $array_4.length; $index_4++) {
    let scheme_4 = $array_4[$index_4];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.add(schemeN_4);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.selectedIndex = 0;
  }
 ...
 m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase() {
  while (!$Equality.$same(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.firstChild, null)) {
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.removeChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_.firstChild);
  }
 }
 ...
 /** @private */
 $init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase() {
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_ = LineChart.$create__();
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeLineCase_ = /**@type {HTMLInputElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("input"), HTMLInputElement_$Overlay));
 }
 
 static $clinit() {
  ColorSchemeLineCase.$clinit = () =>{};
  ColorSchemeLineCase.$loadModules();
  BaseComposite.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ColorSchemeLineCase;
 }
...
$Util.$setClassMetadata(ColorSchemeLineCase, "org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemeLineCase");

exports = ColorSchemeLineCase;

//# sourceMappingURL=ColorSchemeLineCase.js.map
