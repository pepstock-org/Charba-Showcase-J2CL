goog.module('org.pepstock.charba.showcase.j2cl.cases.plugins.PointerLineCase.$1$impl');
...
class $1 extends j_l_Object {
 ...
 constructor() {
  ...
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_1;
 }
 /** @return {!$1} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase(/** PointerLineCase */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_1__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_1__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase(/** PointerLineCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_1 = $outer_this;
 ...
 m_onSelect__org_pepstock_charba_client_events_DatasetSelectionEvent(/** DatasetSelectionEvent */ event) {
  ...
  if (!$Equality.$same(datasets, null) && !datasets.isEmpty()) {
   ...
   this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_1.f_mylog__org_pepstock_charba_showcase_j2cl_cases_plugins_PointerLineCase_.m_addLogEvent__java_lang_String(sb.toString());
  }
 }
...
$Util.$setClassMetadata($1, "org.pepstock.charba.showcase.j2cl.cases.plugins.PointerLineCase$1");

exports = $1;

//# sourceMappingURL=PointerLineCase$1.js.map
