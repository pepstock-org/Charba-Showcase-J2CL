goog.module('org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemePolarAreaCase$impl');
...
class ColorSchemePolarAreaCase extends BaseComposite {
 /** @protected */
 constructor() {
  super();
  /**@type {HTMLTableElement}*/
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
  /**@type {PolarAreaChart}*/
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
  /**@type {HTMLSelectElement}*/
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
  /**@type {HTMLSelectElement}*/
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
  /**@type {HTMLInputElement}*/
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
 }
 /** @return {!ColorSchemePolarAreaCase} */
 static $create__() {
  ColorSchemePolarAreaCase.$clinit();
  let $instance = new ColorSchemePolarAreaCase();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase__() {
  this.$ctor__org_pepstock_charba_showcase_j2cl_cases_commons_BaseComposite__();
  this.$init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase();
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_ = /**@type {HTMLTableElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("table"), $Overlay));
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.width = "100%";
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.cellPadding = "12";
  let chartRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  chartRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.appendChild(chartRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(category1);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(category2);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(category3);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(category4);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(category5);
  let index = 0;
  for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
   let scheme = $array[$index];
   {
    ...
    this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(schemeN);
    if ($Objects.m_equals__java_lang_Object__java_lang_Object(BrewerScheme.f_PAIRED12__org_pepstock_charba_client_impl_plugins_enums_BrewerScheme, scheme)) {
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex = index;
    }
    index = index + 1 | 0;
   }
  }
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_setResponsive__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getLegend__().m_setPosition__org_pepstock_charba_client_enums_Position(Position.f_TOP__org_pepstock_charba_client_enums_Position);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getTitle__().m_setDisplay__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getTitle__().m_setText__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$init(["Coloring polar area chart"], j_l_String)));
  let dataset1 = /**@type {PolarAreaDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_newDataset__(), PolarAreaDataset));
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getPlugins__().m_setOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptions(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, options);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getPlugins__().m_add__org_pepstock_charba_client_Plugin(ColorSchemes.m_get__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getData__().m_setLabels__arrayOf_java_lang_String(this.m_getLabels__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getData__().m_setDatasets__arrayOf_org_pepstock_charba_client_data_Dataset(/**@type {!Array<Dataset>}*/ ($Arrays.$init([dataset1], Dataset)));
  chartCol.appendChild(/**@type {Node}*/ ($Casts.$to(IsCastable_$Overlay.m_as__$devirt__org_pepstock_charba_client_dom_IsCastable(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getChartElement__()), Node_$Overlay)));
  let actionsRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  actionsRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.appendChild(actionsRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.onchange = (/** Event */ p0_3) =>{
   this.m_handleCategory__();
   return null;
  };
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.className = "gwt-ListBox";
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_);
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.onchange = (/** Event */ p0_4) =>{
   this.m_handleName__();
   return null;
  };
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.className = "gwt-ListBox";
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_);
  ...
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.id = reverseID;
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.onclick = (/** Event */ p0_5) =>{
   this.m_handleReverse__();
   return null;
  };
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.type = "checkbox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.className = "gwt-CheckBox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_);
 ...
 m_getElement__() {
  return this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_;
 }
 
 m_handleRandomize__() {
  for (let $iterator = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getData__().m_getDatasets__().m_iterator__(); $iterator.m_hasNext__(); ) {
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_update__();
 }
 
 m_handleAddData__() {
  this.m_addData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_);
 }
 
 m_handleRemoveData__() {
  this.m_removeData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_);
 }
 
 m_handleReverse__() {
  let options = /**@type {ColorSchemesOptions}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getPlugins__().m_getOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptionsFactory(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, ColorSchemes.f_FACTORY__org_pepstock_charba_client_impl_plugins_ColorSchemes), ColorSchemesOptions));
  options.m_setReverse__boolean(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.checked);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_getOptions__().m_getPlugins__().m_setOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptions(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, options);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.m_update__();
 }
 
 m_handleCategory__() {
  let selected = /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.options, this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex), HTMLOptionElement_$Overlay)).value;
  if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("brewer", selected)) {
   this.m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase();
   let index = 0;
   for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
    let scheme = $array[$index];
    {
   ...
   for (let $array_1 = OfficeScheme.m_values__(), $index_1 = 0; $index_1 < $array_1.length; $index_1++) {
    let scheme_1 = $array_1[$index_1];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(schemeN_1);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex = 0;
   ...
   for (let $array_2 = TableauScheme.m_values__(), $index_2 = 0; $index_2 < $array_2.length; $index_2++) {
    let scheme_2 = $array_2[$index_2];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(schemeN_2);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex = 0;
   ...
   for (let $array_3 = GwtMaterialScheme.m_values__(), $index_3 = 0; $index_3 < $array_3.length; $index_3++) {
    let scheme_3 = $array_3[$index_3];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(schemeN_3);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex = 0;
   ...
   for (let $array_4 = GoogleChartScheme.m_values__(), $index_4 = 0; $index_4 < $array_4.length; $index_4++) {
    let scheme_4 = $array_4[$index_4];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.add(schemeN_4);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.selectedIndex = 0;
  }
 ...
 m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase() {
  while (!$Equality.$same(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.firstChild, null)) {
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.removeChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_.firstChild);
  }
 }
 ...
 /** @private */
 $init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase() {
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_ = PolarAreaChart.$create__();
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemePolarAreaCase_ = /**@type {HTMLInputElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("input"), HTMLInputElement_$Overlay));
 }
 
 static $clinit() {
  ColorSchemePolarAreaCase.$clinit = () =>{};
  ColorSchemePolarAreaCase.$loadModules();
  BaseComposite.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ColorSchemePolarAreaCase;
 }
...
$Util.$setClassMetadata(ColorSchemePolarAreaCase, "org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemePolarAreaCase");

exports = ColorSchemePolarAreaCase;

//# sourceMappingURL=ColorSchemePolarAreaCase.js.map
