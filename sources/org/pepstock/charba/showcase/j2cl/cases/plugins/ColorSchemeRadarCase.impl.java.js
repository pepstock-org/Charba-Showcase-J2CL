goog.module('org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemeRadarCase$impl');
...
class ColorSchemeRadarCase extends BaseComposite {
 /** @protected */
 constructor() {
  super();
  /**@type {HTMLTableElement}*/
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
  /**@type {RadarChart}*/
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
  /**@type {HTMLSelectElement}*/
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
  /**@type {HTMLSelectElement}*/
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
  /**@type {HTMLInputElement}*/
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
 }
 /** @return {!ColorSchemeRadarCase} */
 static $create__() {
  ColorSchemeRadarCase.$clinit();
  let $instance = new ColorSchemeRadarCase();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase__() {
  this.$ctor__org_pepstock_charba_showcase_j2cl_cases_commons_BaseComposite__();
  this.$init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase();
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_ = /**@type {HTMLTableElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("table"), $Overlay));
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.width = "100%";
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.cellPadding = "12";
  let chartRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  chartRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.appendChild(chartRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(category1);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(category2);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(category3);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(category4);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(category5);
  let index = 0;
  for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
   let scheme = $array[$index];
   {
    ...
    this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(schemeN);
    if ($Objects.m_equals__java_lang_Object__java_lang_Object(BrewerScheme.f_PAIRED12__org_pepstock_charba_client_impl_plugins_enums_BrewerScheme, scheme)) {
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex = index;
    }
    index = index + 1 | 0;
   }
  }
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_setResponsive__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getLegend__().m_setPosition__org_pepstock_charba_client_enums_Position(Position.f_TOP__org_pepstock_charba_client_enums_Position);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getTitle__().m_setDisplay__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getTitle__().m_setText__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$init(["Coloring radar chart"], j_l_String)));
  let dataset1 = /**@type {RadarDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_newDataset__(), RadarDataset));
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getPlugins__().m_setOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptions(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, options);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getPlugins__().m_add__org_pepstock_charba_client_Plugin(ColorSchemes.m_get__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getData__().m_setLabels__arrayOf_java_lang_String(this.m_getLabels__());
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getData__().m_setDatasets__arrayOf_org_pepstock_charba_client_data_Dataset(/**@type {!Array<Dataset>}*/ ($Arrays.$init([dataset1], Dataset)));
  chartCol.appendChild(/**@type {Node}*/ ($Casts.$to(IsCastable_$Overlay.m_as__$devirt__org_pepstock_charba_client_dom_IsCastable(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getChartElement__()), Node_$Overlay)));
  let actionsRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  actionsRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.appendChild(actionsRow);
  ...
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.onchange = (/** Event */ p0_5) =>{
   this.m_handleCategory__();
   return null;
  };
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.className = "gwt-ListBox";
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.onchange = (/** Event */ p0_6) =>{
   this.m_handleName__();
   return null;
  };
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.className = "gwt-ListBox";
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
  ...
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.id = reverseID;
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.onclick = (/** Event */ p0_7) =>{
   this.m_handleReverse__();
   return null;
  };
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.type = "checkbox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.className = "gwt-CheckBox";
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.style.marginRight = MarginRightUnionType_$Overlay.m_of__java_lang_Object("5px");
  actionsCol.appendChild(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
  let github = /**@type {HTMLButtonElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("button"), HTMLButtonElement_$Overlay));
  github.onclick = (/** Event */ p0_8) =>{
 ...
 m_getElement__() {
  return this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_;
 }
 
 m_handleRandomize__() {
  for (let $iterator = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getData__().m_getDatasets__().m_iterator__(); $iterator.m_hasNext__(); ) {
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_update__();
 }
 
 m_handleAddDataset__() {
  let datasets = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getData__().m_getDatasets__();
  let dataset = /**@type {RadarDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_newDataset__(), RadarDataset));
  dataset.m_setLabel__java_lang_String("dataset " + (datasets.size() + 1 | 0));
  let color = GoogleChartColor.m_values__()[datasets.size()];
  dataset.m_setBackgroundColor__org_pepstock_charba_client_colors_IsColor(color.m_alpha__double(0.2));
  dataset.m_setBorderColor__java_lang_String(color.m_toHex__());
  dataset.m_setBorderWidth__int(2);
  dataset.m_setData__arrayOf_double(this.m_getRandomDigits__int(this.f_months__org_pepstock_charba_showcase_j2cl_cases_commons_AbstractComposite));
 ...
 m_handleRemoveDataset__() {
  this.m_removeDataset__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
 }
 
 m_handleAddData__() {
  this.m_addData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
 }
 
 m_handleRemoveData__() {
  this.m_removeData__org_pepstock_charba_client_IsChart(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_);
 }
 
 m_handleReverse__() {
  let options = /**@type {ColorSchemesOptions}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getPlugins__().m_getOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptionsFactory(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, ColorSchemes.f_FACTORY__org_pepstock_charba_client_impl_plugins_ColorSchemes), ColorSchemesOptions));
  options.m_setReverse__boolean(this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.checked);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_getOptions__().m_getPlugins__().m_setOptions__java_lang_String__org_pepstock_charba_client_plugins_AbstractPluginOptions(ColorSchemes.f_ID__org_pepstock_charba_client_impl_plugins_ColorSchemes, options);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_update__();
 }
 ...
 m_handleCategory__() {
  ...
  if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("brewer", selected)) {
   this.m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase();
   let index = 0;
   for (let $array = BrewerScheme.m_values__(), $index = 0; $index < $array.length; $index++) {
    let scheme = $array[$index];
    {
   ...
   for (let $array_1 = OfficeScheme.m_values__(), $index_1 = 0; $index_1 < $array_1.length; $index_1++) {
    let scheme_1 = $array_1[$index_1];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(schemeN_1);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex = 0;
   ...
   for (let $array_2 = TableauScheme.m_values__(), $index_2 = 0; $index_2 < $array_2.length; $index_2++) {
    let scheme_2 = $array_2[$index_2];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(schemeN_2);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex = 0;
   ...
   for (let $array_3 = GwtMaterialScheme.m_values__(), $index_3 = 0; $index_3 < $array_3.length; $index_3++) {
    let scheme_3 = $array_3[$index_3];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(schemeN_3);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex = 0;
   ...
   for (let $array_4 = GoogleChartScheme.m_values__(), $index_4 = 0; $index_4 < $array_4.length; $index_4++) {
    let scheme_4 = $array_4[$index_4];
    {
     ...
     this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.add(schemeN_4);
    }
   }
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex = 0;
  }
 ...
 m_clearNames___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase() {
  while (!$Equality.$same(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.firstChild, null)) {
   this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.removeChild(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.firstChild);
  }
 }
 ...
 m_handleName__() {
  ...
  let selected = /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value;
  if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("brewer", selected)) {
   options.m_setScheme__org_pepstock_charba_client_impl_plugins_ColorScheme(/**@type {BrewerScheme}*/ ($Casts.$to(Key.m_getKeyByValue__arrayOf_org_pepstock_charba_client_commons_Key__java_lang_String(BrewerScheme.m_values__(), /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value), BrewerScheme)));
   options.m_setBackgroundColorAlpha__double(0.5);
  } else if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("office", selected)) {
   options.m_setScheme__org_pepstock_charba_client_impl_plugins_ColorScheme(/**@type {OfficeScheme}*/ ($Casts.$to(Key.m_getKeyByValue__arrayOf_org_pepstock_charba_client_commons_Key__java_lang_String(OfficeScheme.m_values__(), /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value), OfficeScheme)));
   options.m_setBackgroundColorAlpha__double(0.5);
  } else if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("tableau", selected)) {
   options.m_setScheme__org_pepstock_charba_client_impl_plugins_ColorScheme(/**@type {TableauScheme}*/ ($Casts.$to(Key.m_getKeyByValue__arrayOf_org_pepstock_charba_client_commons_Key__java_lang_String(TableauScheme.m_values__(), /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value), TableauScheme)));
   options.m_setBackgroundColorAlpha__double(0.5);
  } else if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("gwtmaterial", selected)) {
   options.m_setScheme__org_pepstock_charba_client_impl_plugins_ColorScheme(/**@type {GwtMaterialScheme}*/ ($Casts.$to(Key.m_getKeyByValue__arrayOf_org_pepstock_charba_client_commons_Key__java_lang_String(GwtMaterialScheme.m_values__(), /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value), GwtMaterialScheme)));
   options.m_setBackgroundColorAlpha__double(0.95);
  } else if (j_l_String.m_equalsIgnoreCase__java_lang_String__java_lang_String("googlechart", selected)) {
   options.m_setScheme__org_pepstock_charba_client_impl_plugins_ColorScheme(/**@type {GoogleChartScheme}*/ ($Casts.$to(Key.m_getKeyByValue__arrayOf_org_pepstock_charba_client_commons_Key__java_lang_String(GoogleChartScheme.m_values__(), /**@type {HTMLOptionElement}*/ ($Casts.$to(JsArrayLike_$Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.options, this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.selectedIndex), HTMLOptionElement_$Overlay)).value), GoogleChartScheme)));
   options.m_setBackgroundColorAlpha__double(0.5);
  }
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_.m_update__();
 }
 /** @private */
 $init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase() {
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_ = RadarChart.$create__();
  this.f_category__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_name__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_ = /**@type {HTMLSelectElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("select"), HTMLSelectElement_$Overlay));
  this.f_reverse__org_pepstock_charba_showcase_j2cl_cases_plugins_ColorSchemeRadarCase_ = /**@type {HTMLInputElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("input"), HTMLInputElement_$Overlay));
 }
 
 static $clinit() {
  ColorSchemeRadarCase.$clinit = () =>{};
  ColorSchemeRadarCase.$loadModules();
  BaseComposite.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ColorSchemeRadarCase;
 }
...
$Util.$setClassMetadata(ColorSchemeRadarCase, "org.pepstock.charba.showcase.j2cl.cases.plugins.ColorSchemeRadarCase");

exports = ColorSchemeRadarCase;

//# sourceMappingURL=ColorSchemeRadarCase.js.map
