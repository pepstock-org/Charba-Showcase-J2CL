goog.module('org.pepstock.charba.showcase.j2cl.cases.plugins.BackgroundColorBarCase$impl');
...
class BackgroundColorBarCase extends BaseComposite {
 /** @protected */
 constructor() {
  super();
  /**@type {HTMLTableElement}*/
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_;
  /**@type {BarChart}*/
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_;
 }
 /** @return {!BackgroundColorBarCase} */
 static $create__() {
  BackgroundColorBarCase.$clinit();
  let $instance = new BackgroundColorBarCase();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase__() {
  this.$ctor__org_pepstock_charba_showcase_j2cl_cases_commons_BaseComposite__();
  this.$init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase();
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_ = /**@type {HTMLTableElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("table"), $Overlay));
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.width = "100%";
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.cellPadding = "12";
  let chartRow = /**@type {HTMLTableRowElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("tr"), HTMLTableRowElement_$Overlay));
  chartRow.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.appendChild(chartRow);
  let chartCol = /**@type {HTMLTableCellElement}*/ ($Casts.$to(DomGlobal_$Overlay.f_document__elemental2_dom_DomGlobal_$Overlay.createElement("td"), HTMLTableCellElement_$Overlay));
  chartCol.style.width = WidthUnionType_$Overlay.m_of__java_lang_Object("100%");
  chartRow.appendChild(chartCol);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_getOptions__().m_setResponsive__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_getOptions__().m_getLegend__().m_setPosition__org_pepstock_charba_client_enums_Position(Position.f_TOP__org_pepstock_charba_client_enums_Position);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_getOptions__().m_getTitle__().m_setDisplay__boolean(true);
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_getOptions__().m_getTitle__().m_setText__arrayOf_java_lang_String(/**@type {!Array<?string>}*/ ($Arrays.$init(["Chart background plugin on bar chart"], j_l_String)));
  let dataset1 = /**@type {BarDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_newDataset__(), BarDataset));
  ...
  let dataset2 = /**@type {BarDataset}*/ ($Casts.$to(this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_newDataset__(), BarDataset));
  ...
  this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.appendChild(actionsRow);
 ...
 m_getElement__() {
  return this.f_mainPanel__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_;
 }
 
 m_handleRandomize__() {
  for (let $iterator = this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_getData__().m_getDatasets__().m_iterator__(); $iterator.m_hasNext__(); ) {
  ...
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_.m_update__();
 }
 /** @private */
 $init___$p_org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase() {
  this.f_chart__org_pepstock_charba_showcase_j2cl_cases_plugins_BackgroundColorBarCase_ = BarChart.$create__();
 }
 
 static $clinit() {
  BackgroundColorBarCase.$clinit = () =>{};
  BackgroundColorBarCase.$loadModules();
  BaseComposite.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof BackgroundColorBarCase;
 }
...
$Util.$setClassMetadata(BackgroundColorBarCase, "org.pepstock.charba.showcase.j2cl.cases.plugins.BackgroundColorBarCase");

exports = BackgroundColorBarCase;

//# sourceMappingURL=BackgroundColorBarCase.js.map
