goog.module('org.pepstock.charba.showcase.j2cl.cases.charts.MeterCase.$4$impl');
...
class $4 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {MeterCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_4;
 }
 /** @return {!$4} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase(/** MeterCase */ $outer_this) {
  $4.$clinit();
  let $instance = new $4();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_4__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_4__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase(/** MeterCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_4 = $outer_this;
...
$Util.$setClassMetadata($4, "org.pepstock.charba.showcase.j2cl.cases.charts.MeterCase$4");

exports = $4;

//# sourceMappingURL=MeterCase$4.js.map
