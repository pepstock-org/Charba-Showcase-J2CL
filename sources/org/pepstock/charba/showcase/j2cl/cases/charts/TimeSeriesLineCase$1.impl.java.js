goog.module('org.pepstock.charba.showcase.j2cl.cases.charts.TimeSeriesLineCase.$1$impl');
...
class $1 extends AbstractTooltipTitleCallback {
 ...
 constructor() {
  super();
  /**@type {TimeSeriesLineCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1;
  /**@type {DateAdapter}*/
  this.$captured_adapter__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1;
 }
 /** @return {!$1} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase__org_pepstock_charba_client_adapters_DateAdapter(/** TimeSeriesLineCase */ $outer_this, /** DateAdapter */ $captured_adapter) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase__org_pepstock_charba_client_adapters_DateAdapter($outer_this, $captured_adapter);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase__org_pepstock_charba_client_adapters_DateAdapter(/** TimeSeriesLineCase */ $outer_this, /** DateAdapter */ $captured_adapter) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1 = $outer_this;
  this.$captured_adapter__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesLineCase_1 = $captured_adapter;
...
$Util.$setClassMetadata($1, "org.pepstock.charba.showcase.j2cl.cases.charts.TimeSeriesLineCase$1");

exports = $1;

//# sourceMappingURL=TimeSeriesLineCase$1.js.map
