goog.module('org.pepstock.charba.showcase.j2cl.cases.charts.TimeSeriesByLineCase.$1$impl');
...
class $1 extends AbstractTooltipTitleCallback {
 ...
 constructor() {
  super();
  /**@type {TimeSeriesByLineCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase_1;
 }
 /** @return {!$1} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase(/** TimeSeriesByLineCase */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase(/** TimeSeriesByLineCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_TimeSeriesByLineCase_1 = $outer_this;
...
$Util.$setClassMetadata($1, "org.pepstock.charba.showcase.j2cl.cases.charts.TimeSeriesByLineCase$1");

exports = $1;

//# sourceMappingURL=TimeSeriesByLineCase$1.js.map
