goog.module('org.pepstock.charba.showcase.j2cl.cases.charts.GaugeCase.$1$impl');
...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {GaugeCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase_1;
 }
 /** @return {!$1} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase(/** GaugeCase */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase_1__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase(/** GaugeCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_GaugeCase_1 = $outer_this;
...
$Util.$setClassMetadata($1, "org.pepstock.charba.showcase.j2cl.cases.charts.GaugeCase$1");

exports = $1;

//# sourceMappingURL=GaugeCase$1.js.map
