goog.module('org.pepstock.charba.showcase.j2cl.cases.charts.MeterCase.$3$impl');
...
class $3 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {MeterCase}*/
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_3;
 }
 /** @return {!$3} */
 static $create__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase(/** MeterCase */ $outer_this) {
  $3.$clinit();
  let $instance = new $3();
  $instance.$ctor__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_3__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase($outer_this);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_3__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase(/** MeterCase */ $outer_this) {
  this.$outer_this__org_pepstock_charba_showcase_j2cl_cases_charts_MeterCase_3 = $outer_this;
  this.$ctor__java_lang_Object__();
 }
 /** @return {?string} */
 m_invoke__org_pepstock_charba_client_impl_charts_MeterContext(/** MeterContext */ context) {
  return j_l_String.m_valueOf__java_lang_Object(Utilities.m_applyPrecision__double__int(context.m_getValue__(), 0)) + " MB";
 }
 //Bridge method.
...
$Util.$setClassMetadata($3, "org.pepstock.charba.showcase.j2cl.cases.charts.MeterCase$3");

exports = $3;

//# sourceMappingURL=MeterCase$3.js.map
