...
class ShowAndHideDefaultAnimationCollection extends DefaultAnimationCollection {
 ...
 $ctor__org_pepstock_charba_client_defaults_globals_DefaultTransitions_ShowAndHideDefaultAnimationTransition_ShowAndHideDefaultAnimationCollection__() {
  this.$ctor__org_pepstock_charba_client_defaults_globals_DefaultAnimationCollection__org_pepstock_charba_client_options_IsAnimationCollectionKey(DefaultAnimationCollectionKey.f_COLORS__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey);
 }
