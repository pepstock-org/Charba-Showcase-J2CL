goog.module('org.pepstock.charba.client.callbacks.AbstractDatasetContext.Property$impl');
...
class Property extends Enum {
 ...
 constructor() {
  super();
  /**@type {?string}*/
  this.f_value__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_;
 }
 /** @return {!Property} */
 static $create__java_lang_String__int__java_lang_String(/** ?string */ $name, /** number */ $ordinal, /** ?string */ value) {
  let $instance = new Property();
  $instance.$ctor__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property__java_lang_String__int__java_lang_String($name, $ordinal, value);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property__java_lang_String__int__java_lang_String(/** ?string */ $name, /** number */ $ordinal, /** ?string */ value) {
  this.f_name__java_lang_Enum_ = $name;
  this.f_ordinal__java_lang_Enum_ = $ordinal;
  this.$ctor__java_lang_Enum__java_lang_String__int($name, $ordinal);
  this.f_value__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_ = value;
 }
 /** @override @return {?string} */
 m_value__() {
  return this.f_value__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_;
 }
 /** @return {!Property} */
 static m_valueOf__java_lang_String(/** string */ name) {
  Property.$clinit();
  if ($Equality.$same(Property.f_namesToValuesMap__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_, null)) {
   Property.f_namesToValuesMap__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_ = $Enums.createMapFromValues(Property.m_values__());
  }
  return $Enums.getValueFromNameAndMap(name, Property.f_namesToValuesMap__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property_);
 }
 ...
 static get f_ACTIVE__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property() {
  return (Property.$clinit(), Property.$static_ACTIVE__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property);
 }
 /** @return {!Property} */
 static get f_DATASET_INDEX__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property() {
  return (Property.$clinit(), Property.$static_DATASET_INDEX__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property);
 }
 /** @return {!Property} */
...
/**@const {number}*/
Property.$ordinal_ACTIVE__org_pepstock_charba_client_callbacks_AbstractDatasetContext_Property = 0;
/**@const {number}*/
...
//# sourceMappingURL=AbstractDatasetContext$Property.js.map
