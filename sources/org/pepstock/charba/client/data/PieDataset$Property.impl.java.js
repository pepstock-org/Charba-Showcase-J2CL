...
/**@const {number}*/
Property.$ordinal_BORDER_RADIUS__org_pepstock_charba_client_data_PieDataset_Property = 0;
/**@const {number}*/
Property.$ordinal_CIRCUMFERENCE__org_pepstock_charba_client_data_PieDataset_Property = 1;
/**@const {number}*/
Property.$ordinal_HOVER_OFFSET__org_pepstock_charba_client_data_PieDataset_Property = 2;
/**@const {number}*/
Property.$ordinal_OFFSET__org_pepstock_charba_client_data_PieDataset_Property = 3;
/**@const {number}*/
