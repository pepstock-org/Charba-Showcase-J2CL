...
class DefaultAnimationCollectionKey extends Enum {
 ...
 static $create__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey(/** ?string */ $name, /** number */ $ordinal, /** ?string */ value, /** Array<IsAnimationPropertyKey> */ properties) {
  let $instance = new DefaultAnimationCollectionKey();
  $instance.$ctor__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey($name, $ordinal, value, properties);
  return $instance;
 }
 
 $ctor__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey(/** ?string */ $name, /** number */ $ordinal, /** ?string */ value, /** Array<IsAnimationPropertyKey> */ properties) {
  ...
  this.f_type__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey_ = /**@type {IsAnimationPropertyKey}*/ ($Casts.$to(this.f_properties__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey_.getAtIndex(0), IsAnimationPropertyKey)).m_type__();
 }
 ...
 m_properties__() {
  return /**@type {List<IsAnimationPropertyKey>}*/ (Collections.m_unmodifiableList__java_util_List(this.f_properties__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey_));
 }
 /** @return {boolean} */
 static m_is__org_pepstock_charba_client_options_IsAnimationCollectionKey(/** IsAnimationCollectionKey */ collection) {
 ...
 $init___$p_org_pepstock_charba_client_enums_DefaultAnimationCollectionKey() {
  this.f_properties__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey_ = /**@type {!LinkedList<IsAnimationPropertyKey>}*/ (LinkedList.$create__());
 }
 /** @return {!DefaultAnimationCollectionKey} */
 ...
 static $clinit() {
  ...
  Enum.$clinit();
  DefaultAnimationCollectionKey.$static_COLORS__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey = DefaultAnimationCollectionKey.$create__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey($Util.$makeEnumName("COLORS"), DefaultAnimationCollectionKey.$ordinal_COLORS__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey, "colors", /**@type {!Array<IsAnimationPropertyKey>}*/ ($Arrays.$init([DefaultAnimationPropertyKey.f_COLOR__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_BORDER_COLOR__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_BACKGROUND_COLOR__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey], IsAnimationPropertyKey)));
  DefaultAnimationCollectionKey.$static_NUMBERS__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey = DefaultAnimationCollectionKey.$create__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey($Util.$makeEnumName("NUMBERS"), DefaultAnimationCollectionKey.$ordinal_NUMBERS__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey, "numbers", /**@type {!Array<IsAnimationPropertyKey>}*/ ($Arrays.$init([DefaultAnimationPropertyKey.f_X__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_Y__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_BORDER_WIDTH__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_RADIUS__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey, DefaultAnimationPropertyKey.f_TENSION__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey], IsAnimationPropertyKey)));
  DefaultAnimationCollectionKey.$static_VISIBLE__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey = DefaultAnimationCollectionKey.$create__java_lang_String__int__java_lang_String__arrayOf_org_pepstock_charba_client_options_IsAnimationPropertyKey($Util.$makeEnumName("VISIBLE"), DefaultAnimationCollectionKey.$ordinal_VISIBLE__org_pepstock_charba_client_enums_DefaultAnimationCollectionKey, "visible", /**@type {!Array<IsAnimationPropertyKey>}*/ ($Arrays.$init([DefaultAnimationPropertyKey.f_VISIBLE__org_pepstock_charba_client_enums_DefaultAnimationPropertyKey], IsAnimationPropertyKey)));
...
IsAnimationCollectionKey.$markImplementor(DefaultAnimationCollectionKey);
