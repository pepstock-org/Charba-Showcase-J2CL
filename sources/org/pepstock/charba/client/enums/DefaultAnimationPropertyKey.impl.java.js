...
class DefaultAnimationPropertyKey extends Enum {
 ...
 /** @return {boolean} */
 static m_is__org_pepstock_charba_client_options_IsAnimationPropertyKey(/** IsAnimationPropertyKey */ property) {
...
IsAnimationPropertyKey.$markImplementor(DefaultAnimationPropertyKey);
