goog.module('org.pepstock.charba.client.plugins.AbstractPlugin$impl');
 ...
 * @implements {Plugin}
 */
class AbstractPlugin extends j_l_Object {
 /** @protected */
 constructor() {
  super();
  /**@type {?string}*/
  this.f_pluginId__org_pepstock_charba_client_plugins_AbstractPlugin_;
 }
 
 $ctor__org_pepstock_charba_client_plugins_AbstractPlugin__java_lang_String(/** ?string */ pluginId) {
  this.$ctor__java_lang_Object__();
  PluginIdChecker.m_check__java_lang_String(pluginId);
  this.f_pluginId__org_pepstock_charba_client_plugins_AbstractPlugin_ = pluginId;
 }
 /** @override @return {?string} */
 m_getId__() {
  return this.f_pluginId__org_pepstock_charba_client_plugins_AbstractPlugin_;
 }
 /** @override @return {?string} */
 toString() {
  return "Plugin [" + j_l_String.m_valueOf__java_lang_Object(this.m_getId__()) + "]";
 }
...
Plugin.$markImplementor(AbstractPlugin);
$Util.$setClassMetadata(AbstractPlugin, "org.pepstock.charba.client.plugins.AbstractPlugin");
