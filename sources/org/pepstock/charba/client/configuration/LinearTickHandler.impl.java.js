...
class LinearTickHandler extends AbstractTickHandler {
 ...
 $ctor__org_pepstock_charba_client_configuration_LinearTickHandler__org_pepstock_charba_client_configuration_Axis__org_pepstock_charba_client_configuration_Tick(/** Axis */ axis, /** T */ configuration) {
  ...
  this.f_tickCallbackProxy__org_pepstock_charba_client_configuration_LinearTickHandler_.callback = (/** number */ value, /** number */ index, /** Array */ values) =>{
 ...
 $init___$p_org_pepstock_charba_client_configuration_LinearTickHandler() {
  this.f_tickCallbackProxy__org_pepstock_charba_client_configuration_LinearTickHandler_ = /**@type {CharbaCallbackProxy<?function(number, number, Array):?string>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
 }
