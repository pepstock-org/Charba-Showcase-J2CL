goog.module('org.pepstock.charba.client.options.HasPointStyle.$LambdaAdaptor');
...
const $LambdaAdaptor = goog.require('org.pepstock.charba.client.options.HasPointStyle.$LambdaAdaptor$impl');
