...
class HasPointStyle {
 ...
 /** @return {boolean} */
 static m_isPointStyleAsImage__$default__org_pepstock_charba_client_options_HasPointStyle(/** !HasPointStyle */ $thisArg) {
  HasPointStyle.$clinit();
  if (!$Equality.$same($thisArg.m_getPointStyleHandler__(), null)) {
   return $thisArg.m_getPointStyleHandler__().m_isPointStyleAsImage___$pp_org_pepstock_charba_client_options();
  }
  return false;
 }
