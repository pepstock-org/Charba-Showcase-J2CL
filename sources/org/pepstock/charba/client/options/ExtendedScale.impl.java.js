...
class ExtendedScale extends Scale {
 ...
 static $create__org_pepstock_charba_client_configuration_ConfigurationEnvelop__org_pepstock_charba_client_configuration_AxisType__org_pepstock_charba_client_enums_AxisKind__org_pepstock_charba_client_defaults_IsDefaultScale(/** ConfigurationEnvelop<ScaleId> */ envelop, /** AxisType */ type, /** AxisKind */ kind, /** IsDefaultScale */ defaultValues) {
  ExtendedScale.$clinit();
  let $instance = new ExtendedScale();
  $instance.$ctor__org_pepstock_charba_client_options_ExtendedScale__org_pepstock_charba_client_configuration_ConfigurationEnvelop__org_pepstock_charba_client_configuration_AxisType__org_pepstock_charba_client_enums_AxisKind__org_pepstock_charba_client_defaults_IsDefaultScale(envelop, type, kind, defaultValues);
  return $instance;
 }
 //Initialization from constructor 'ExtendedScale(ConfigurationEnvelop, AxisType, AxisKind, IsDefaultScale)'.
 
 $ctor__org_pepstock_charba_client_options_ExtendedScale__org_pepstock_charba_client_configuration_ConfigurationEnvelop__org_pepstock_charba_client_configuration_AxisType__org_pepstock_charba_client_enums_AxisKind__org_pepstock_charba_client_defaults_IsDefaultScale(/** ConfigurationEnvelop<ScaleId> */ envelop, /** AxisType */ type, /** AxisKind */ kind, /** IsDefaultScale */ defaultValues) {
  this.$ctor__org_pepstock_charba_client_options_Scale__org_pepstock_charba_client_configuration_AxisType__org_pepstock_charba_client_defaults_IsDefaultScale(type, defaultValues);
