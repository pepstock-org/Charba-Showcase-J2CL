goog.module('org.pepstock.charba.client.annotation.DefaultBox$impl');
 ...
 */
class DefaultBox extends j_l_Object {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DefaultBox} */
 static $create__() {
  let $instance = new DefaultBox();
  $instance.$ctor__org_pepstock_charba_client_annotation_DefaultBox__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_client_annotation_DefaultBox__() {
  this.$ctor__java_lang_Object__();
 }
 /** @override @return {AnnotationType} */
 m_getType__() {
  return AnnotationType.f_BOX__org_pepstock_charba_client_annotation_AnnotationType;
 }
 ...
 /** @override @return {number} */
 m_getBorderWidth__() {
  return IsDefaultsBoxAnnotation.m_getBorderWidth__$default__org_pepstock_charba_client_annotation_IsDefaultsBoxAnnotation(this);
 }
 //Default method forwarding stub.
 ...
 /** @override @return {number} */
 m_getCornerRadius__() {
  return IsDefaultsBoxAnnotation.m_getCornerRadius__$default__org_pepstock_charba_client_annotation_IsDefaultsBoxAnnotation(this);
 }
 //Default method forwarding stub.
 /** @override @return {CornerRadiusCallback<AnnotationContext>} */
 m_getCornerRadiusCallback__() {
  return IsDefaultsBoxAnnotation.m_getCornerRadiusCallback__$default__org_pepstock_charba_client_annotation_IsDefaultsBoxAnnotation(this);
 }
 /** @return {DefaultBox} */
 static get f_INSTANCE__org_pepstock_charba_client_annotation_DefaultBox() {
  return (DefaultBox.$clinit(), DefaultBox.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultBox);
 }
 
 static $clinit() {
  DefaultBox.$clinit = () =>{};
  DefaultBox.$loadModules();
  j_l_Object.$clinit();
  IsDefaultsBoxAnnotation.$clinit();
  DefaultBox.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultBox = DefaultBox.$create__();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DefaultBox;
 }
...
/**@private {DefaultBox}*/
DefaultBox.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultBox;
IsDefaultsBoxAnnotation.$markImplementor(DefaultBox);
$Util.$setClassMetadata(DefaultBox, "org.pepstock.charba.client.annotation.DefaultBox");

exports = DefaultBox;

//# sourceMappingURL=DefaultBox.js.map
