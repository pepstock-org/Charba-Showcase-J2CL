goog.module('org.pepstock.charba.client.annotation.IsDefaultsLineAnnotation.$LambdaAdaptor$impl');
...
class $LambdaAdaptor extends j_l_Object {
 ...
 constructor(/** ?function():IsDefaultsLineLabel */ fn) {
  $LambdaAdaptor.$clinit();
  super();
  /**@type {?function():IsDefaultsLineLabel}*/
  this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$LambdaAdaptor;
  this.$ctor__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$LambdaAdaptor__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$JsFunction(fn);
 }
 
 $ctor__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$LambdaAdaptor__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$JsFunction(/** ?function():IsDefaultsLineLabel */ fn) {
  this.$ctor__java_lang_Object__();
  this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$LambdaAdaptor = fn;
 }
 /** @override @return {IsDefaultsLineLabel} */
 m_getLabel__() {
  let /** ?function():IsDefaultsLineLabel */ $function;
  return ($function = this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation_$LambdaAdaptor, $function());
 }
 ...
 m_getType__() {
  return IsDefaultsLineAnnotation.m_getType__$default__org_pepstock_charba_client_annotation_IsDefaultsLineAnnotation(this);
 }
 //Default method forwarding stub.
...
IsDefaultsLineAnnotation.$markImplementor($LambdaAdaptor);
$Util.$setClassMetadata($LambdaAdaptor, "org.pepstock.charba.client.annotation.IsDefaultsLineAnnotation$$LambdaAdaptor");

exports = $LambdaAdaptor;

//# sourceMappingURL=IsDefaultsLineAnnotation$$LambdaAdaptor.js.map
