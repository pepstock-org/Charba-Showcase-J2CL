goog.module('org.pepstock.charba.client.annotation.DefaultEllipse$impl');
 ...
 */
class DefaultEllipse extends j_l_Object {
 /** @protected */
 constructor() {
  super();
 }
 ...
 static $create__() {
  let $instance = new DefaultEllipse();
  $instance.$ctor__org_pepstock_charba_client_annotation_DefaultEllipse__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_client_annotation_DefaultEllipse__() {
  this.$ctor__java_lang_Object__();
 }
 /** @override @return {AnnotationType} */
 m_getType__() {
  return AnnotationType.f_ELLIPSE__org_pepstock_charba_client_annotation_AnnotationType;
 }
 ...
 /** @return {DefaultEllipse} */
 static get f_INSTANCE__org_pepstock_charba_client_annotation_DefaultEllipse() {
  return (DefaultEllipse.$clinit(), DefaultEllipse.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultEllipse);
 }
 
 static $clinit() {
  DefaultEllipse.$clinit = () =>{};
  DefaultEllipse.$loadModules();
  j_l_Object.$clinit();
  IsDefaultsEllipseAnnotation.$clinit();
  DefaultEllipse.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultEllipse = DefaultEllipse.$create__();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DefaultEllipse;
 }
...
DefaultEllipse.$static_INSTANCE__org_pepstock_charba_client_annotation_DefaultEllipse;
IsDefaultsEllipseAnnotation.$markImplementor(DefaultEllipse);
$Util.$setClassMetadata(DefaultEllipse, "org.pepstock.charba.client.annotation.DefaultEllipse");

exports = DefaultEllipse;

//# sourceMappingURL=DefaultEllipse.js.map
