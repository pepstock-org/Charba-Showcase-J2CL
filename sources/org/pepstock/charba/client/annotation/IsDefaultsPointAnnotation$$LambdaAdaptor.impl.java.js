goog.module('org.pepstock.charba.client.annotation.IsDefaultsPointAnnotation.$LambdaAdaptor$impl');
...
class $LambdaAdaptor extends j_l_Object {
 ...
 constructor(/** ?function():AnnotationType */ fn) {
  ...
  this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$LambdaAdaptor;
  this.$ctor__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$LambdaAdaptor__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$JsFunction(fn);
 }
 
 $ctor__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$LambdaAdaptor__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$JsFunction(/** ?function():AnnotationType */ fn) {
  this.$ctor__java_lang_Object__();
  this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$LambdaAdaptor = fn;
 }
 /** @override @return {AnnotationType} */
 m_getType__() {
  let /** ?function():AnnotationType */ $function;
  return ($function = this.f_fn__org_pepstock_charba_client_annotation_IsDefaultsPointAnnotation_$LambdaAdaptor, $function());
 }
...
IsDefaultsPointAnnotation.$markImplementor($LambdaAdaptor);
$Util.$setClassMetadata($LambdaAdaptor, "org.pepstock.charba.client.annotation.IsDefaultsPointAnnotation$$LambdaAdaptor");

exports = $LambdaAdaptor;

//# sourceMappingURL=IsDefaultsPointAnnotation$$LambdaAdaptor.js.map
