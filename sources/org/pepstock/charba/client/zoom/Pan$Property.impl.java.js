...
/**@const {number}*/
Property.$ordinal_MODIFIER_KEY__org_pepstock_charba_client_zoom_Pan_Property = 0;
/**@const {number}*/
Property.$ordinal_ON_PAN__org_pepstock_charba_client_zoom_Pan_Property = 1;
/**@const {number}*/
Property.$ordinal_ON_PAN_START__org_pepstock_charba_client_zoom_Pan_Property = 2;
/**@const {number}*/
Property.$ordinal_ON_PAN_COMPLETED__org_pepstock_charba_client_zoom_Pan_Property = 3;
/**@const {number}*/
Property.$ordinal_ON_PAN_REJECTED__org_pepstock_charba_client_zoom_Pan_Property = 4;
