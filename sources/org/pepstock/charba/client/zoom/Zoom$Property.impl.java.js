...
class Property extends Enum {
 ...
 static m_values__() {
  Property.$clinit();
  return /**@type {!Array<Property>}*/ ($Arrays.$init([Property.$static_SPEED__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_DRAG__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_ON_ZOOM__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_ON_ZOOM_START__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_ON_ZOOM_COMPLETED__org_pepstock_charba_client_zoom_Zoom_Property, Property.$static_ON_ZOOM_REJECTED__org_pepstock_charba_client_zoom_Zoom_Property], Property));
 }
 /** @return {!Property} */
 static get f_SPEED__org_pepstock_charba_client_zoom_Zoom_Property() {
  return (Property.$clinit(), Property.$static_SPEED__org_pepstock_charba_client_zoom_Zoom_Property);
 }
 /** @return {!Property} */
 ...
 /** @return {!Property} */
 static get f_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property() {
  return (Property.$clinit(), Property.$static_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property);
 }
 /** @return {!Property} */
 ...
 static $clinit() {
  ...
  Enum.$clinit();
  Property.$static_SPEED__org_pepstock_charba_client_zoom_Zoom_Property = Property.$create__java_lang_String__int__java_lang_String($Util.$makeEnumName("SPEED"), Property.$ordinal_SPEED__org_pepstock_charba_client_zoom_Zoom_Property, "speed");
  ...
  Property.$static_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property = Property.$create__java_lang_String__int__java_lang_String($Util.$makeEnumName("WHEEL_MODIFIER_KEY"), Property.$ordinal_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property, "wheelModifierKey");
...
/**@private {!Property}*/
Property.$static_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property;
/**@private {!Property}*/
...
/**@const {number}*/
Property.$ordinal_SPEED__org_pepstock_charba_client_zoom_Zoom_Property = 0;
/**@const {number}*/
Property.$ordinal_DRAG__org_pepstock_charba_client_zoom_Zoom_Property = 1;
/**@const {number}*/
Property.$ordinal_WHEEL_MODIFIER_KEY__org_pepstock_charba_client_zoom_Zoom_Property = 2;
/**@const {number}*/
