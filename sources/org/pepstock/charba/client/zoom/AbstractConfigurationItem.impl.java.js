 ...
 */
class AbstractConfigurationItem extends AbstractNode {
 /** @protected */
 constructor() {
  super();
 ...
 $ctor__org_pepstock_charba_client_zoom_AbstractConfigurationItem__org_pepstock_charba_client_commons_NativeObject(/** ? */ nativeObject) {
  ...
  this.f_modeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context) =>{
  ...
  this.f_overScaleModeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context_1) =>{
  ...
  this.f_progressCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context_2) =>{
  ...
  this.f_completeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context_3) =>{
  ...
  this.f_rejectCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context_4) =>{
  ...
  this.f_startCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.callback = (/** ? */ context_5) =>{
 ...
 m_setMode__org_pepstock_charba_client_callbacks_NativeCallback(/** Function */ modeCallback) {
  this.m_setMode__org_pepstock_charba_client_zoom_callbacks_ModeCallback(/**@type {ModeCallback}*/ (null));
  this.m_setValue__org_pepstock_charba_client_commons_Key__org_pepstock_charba_client_callbacks_NativeCallback(Property.f_MODE__org_pepstock_charba_client_zoom_AbstractConfigurationItem_Property, modeCallback);
 }
 /** @override @return {ModeCallback} */
 ...
 m_setOverScaleMode__org_pepstock_charba_client_callbacks_NativeCallback(/** Function */ modeCallback) {
  this.m_setOverScaleMode__org_pepstock_charba_client_zoom_callbacks_ModeCallback(/**@type {ModeCallback}*/ (null));
  this.m_setValue__org_pepstock_charba_client_commons_Key__org_pepstock_charba_client_callbacks_NativeCallback(Property.f_OVER_SCALE_MODE__org_pepstock_charba_client_zoom_AbstractConfigurationItem_Property, modeCallback);
 }
 ...
 m_setProgressCallback__org_pepstock_charba_client_zoom_callbacks_ProgressCallback(/** ProgressCallback */ progressCallback) {
  this.m_getProgessPropertyHandler___$pp_org_pepstock_charba_client_zoom().m_setCallback__org_pepstock_charba_client_commons_AbstractNode__java_lang_String__java_lang_Object__org_pepstock_charba_client_commons_CallbackProxy_Proxy(this, ZoomPlugin.f_ID__org_pepstock_charba_client_zoom_ZoomPlugin, progressCallback, this.f_progressCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.proxy);
 }
 ...
 m_setRejectedCallback__org_pepstock_charba_client_zoom_callbacks_RejectedCallback(/** RejectedCallback */ rejectCallback) {
  this.m_getRejectedPropertyHandler___$pp_org_pepstock_charba_client_zoom().m_setCallback__org_pepstock_charba_client_commons_AbstractNode__java_lang_String__java_lang_Object__org_pepstock_charba_client_commons_CallbackProxy_Proxy(this, ZoomPlugin.f_ID__org_pepstock_charba_client_zoom_ZoomPlugin, rejectCallback, this.f_rejectCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_.proxy);
 }
 ...
 $init___$p_org_pepstock_charba_client_zoom_AbstractConfigurationItem() {
  this.f_modeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):?string>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
  this.f_overScaleModeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):?string>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
  this.f_progressCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):void>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
  this.f_completeCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):void>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
  this.f_rejectCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):void>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
  this.f_startCallbackProxy__org_pepstock_charba_client_zoom_AbstractConfigurationItem_ = /**@type {CharbaCallbackProxy<?function(?):boolean>}*/ (JsHelper.m_get__().m_newCallbackProxy__());
 }
