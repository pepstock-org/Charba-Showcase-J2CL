goog.module('org.pepstock.charba.client.geo.ChoroplethDataset.ChoroplethDataPointFactory$impl');
...
class ChoroplethDataPointFactory extends j_l_Object {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_pepstock_charba_client_geo_ChoroplethDataset_ChoroplethDataPointFactory__();
  return $instance;
 }
 
 $ctor__org_pepstock_charba_client_geo_ChoroplethDataset_ChoroplethDataPointFactory__() {
...
$Util.$setClassMetadata(ChoroplethDataPointFactory, "org.pepstock.charba.client.geo.ChoroplethDataset$ChoroplethDataPointFactory");

exports = ChoroplethDataPointFactory;

//# sourceMappingURL=ChoroplethDataset$ChoroplethDataPointFactory.js.map
