...
class $Overlay {
 ...
 static m_of__java_lang_String__java_lang_Object(/** ?string */ k, /** T */ v) {
  $Overlay.$clinit();
  let map = /**@type {Object<string, T>}*/ ($Overlay.m_of__());
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k, v);
  return map;
 }
 /** @template T @return {Object<string, T>} */
 static m_of__java_lang_String__java_lang_Object__java_lang_String__java_lang_Object(/** ?string */ k1, /** T */ v1, /** ?string */ k2, /** T */ v2) {
  $Overlay.$clinit();
  let map = /**@type {Object<string, T>}*/ ($Overlay.m_of__());
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k1, v1);
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k2, v2);
  return map;
 }
 /** @template T @return {Object<string, T>} */
 static m_of__java_lang_String__java_lang_Object__java_lang_String__java_lang_Object__java_lang_String__java_lang_Object(/** ?string */ k1, /** T */ v1, /** ?string */ k2, /** T */ v2, /** ?string */ k3, /** T */ v3) {
  ...
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k1, v1);
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k2, v2);
  $Overlay.m_set__$devirt__jsinterop_base_JsPropertyMap__java_lang_String__java_lang_Object(map, k3, v3);
  return map;
 }
 /** @template T @return {T} */
 ...
 static m_getAny__$devirt__jsinterop_base_JsPropertyMap__java_lang_String(/** !Object<string, T> */ $thisArg, /** ?string */ propertyName) {
  $Overlay.$clinit();
  return $Overlay.m_getAsAny__$devirt__jsinterop_base_JsPropertyMap__java_lang_String($thisArg, propertyName);
 }
 /** @template T @return {*} */
